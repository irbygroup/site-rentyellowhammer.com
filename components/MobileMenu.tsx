...
export function MobileMenu({ links }: { links: NavLink[] }) {
  ...
  return (
    <div className="lg:hidden">
      ...
      {open && (
        <div className="absolute left-0 right-0 top-full bg-dark-bg shadow-lg">
            ...
            {links.map((link) =>
              link.external ? (
                <a
                  ...
                  className="border-b border-white/10 py-3 text-white transition-colors hover:text-gold"
